...
import com.cqjtu.cosmetology.dao.BusinessDao;
...
public class BusinessServiceImpl implements BusinessService {
    ...
    @Override
    public ResponseData queryBusById(Long id) {
        try {
            Business businessByid =businessDao.queryBusById(id);
            return new ResponseData(ResponseCode.SUCCESS01,businessByid);
        }catch (Exception e) {
